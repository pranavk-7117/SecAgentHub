          ...
          <div className="relative flex flex-col gap-5 p-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="flex shrink-0 items-center gap-3 self-start">
              <Link href={`/scan/${scan.id}/twin`}>
                <button className="inline-flex items-center gap-1.5 rounded-lg border border-purple-500/30 bg-purple-500/10 px-4 py-2 text-sm font-semibold text-purple-400 transition hover:bg-purple-500/20">
                  <GitBranch className="h-4 w-4" />
                  Digital Twin
                </button>
              </Link>
              <Link href={`/scan/${scan.id}/ci`}>
                <button className="inline-flex items-center gap-1.5 rounded-lg border border-blue-500/30 bg-blue-500/10 px-4 py-2 text-sm font-semibold text-blue-400 transition hover:bg-blue-500/20">
